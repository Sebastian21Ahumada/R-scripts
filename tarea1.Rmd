...
library(tidyverse)
library(readr)
library(dplyr) # Use of operator pipe %>% 
library(ggplot2)
library(psych) # Use of describe
library(waterfalls) 
...
setwd('/Users/sebastianahumada/Desktop/Magister/Taller de visualización de datos') #Need to be changed
getwd()
...
waterfall(df_promedio2, calc_total = TRUE,
      ...
      labs(title = "Number of births compared to last year", x = "Años", y = "Total Nacimientos") +
  labs(x = "Año", y = "Total de Nacimientos")
